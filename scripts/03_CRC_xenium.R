...
setwd("/BiO/home/edu01/2024_KOGO_visium/")
...
xenium.obj <- LoadXenium('./data/xenium/Xenium_V1_Human_Colon_Cancer_P2_CRC_Add_on_FFPE_outs/', fov = 'fov')
...
xenium.obj <- readRDS('results/xenium/xenium_preprocessed.rds')
...
ImageDimPlot(xenium.obj, cols = "polychrome", size = 1.0)