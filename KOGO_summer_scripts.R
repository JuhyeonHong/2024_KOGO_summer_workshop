...
### Load Brain Data --------
setwd("2023_KOGO_summer_workshop_data") # Dropbox 폴더를 다운로드 받은 후에 폴더의 위치로 경로 설정해야합니다.

#options(timeout = 600000000)
#InstallData("stxBrain") # 컴퓨터 사양에 따라 다운로드 받는 데 시간이 소요될 수 있습니다.
#brain = LoadData("stxBrain", type = "anterior1")

brain = readRDS("./KOGO_brain.rds")
...
#   RunPCA(verbose = FALSE) %>% RunUMAP(dims = 1:30) # 컴퓨터 사양에 따라 5-20분 소요.

allen_reference = readRDS("./KOGO_sc_allen_cortex_processed.rds")
